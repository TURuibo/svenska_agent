...
cefr: "A2"
zh: "药品；药物；医学"
en: "medicine; medication; medical science"
synonyms: [läkemedel]
antonyms: []
family: [medicinsk, medicinera]
topics: [topic-hälsa]
sentences:
...
|------|---------|
| grundform | medicin |
| bestämd form | medicinen |
| plural obestämd | mediciner |
| plural bestämd | medicinerna |

## 词组搭配 (Collocations)

- `ta medicin` — 服药
- `gamla mediciner` — 旧药品（过期药）
- `skriva ut medicin` — 开药/开处方
...
- 日常口语多用 `medicin`，医疗/法律语境更多用 `läkemedel`
- 注意区分：`medicin`（药品/医学）vs `medicinsk`（医学的/医疗的，形容词）

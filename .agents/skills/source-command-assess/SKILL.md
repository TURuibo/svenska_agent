...
Use the `sv-assess` skill and spawn the `sv-assessor` subagent. It scans `knowledge_base/`,
estimates a CEFR/SFI band with concrete evidence, and updates `profile/level.md`
